...
def createHistoryOptput(histIntervals):
	...
	#Create history output U2 at senter of slab
	nodes1 = M.rootAssembly.instances['SLAB_A1-1'].nodes[65:66]
	M.rootAssembly.Set(nodes=nodes1, name='centerSlab')
	regionDef=M.rootAssembly.sets['centerSlab']
	M.HistoryOutputRequest(name='slabU2', 
	    createStepName=stepName, variables=('U2', ), region=regionDef, 
